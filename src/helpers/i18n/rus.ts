...
export const rus: LanguageMap = {
  ...
  'combination.1.title': 'Сумма всех костей, на которых выпали единицы. ### Возможны 3, 4 или 5 очков.',
  'combination.2': 'Двойки',
  'combination.2.title': 'Сумма всех костей, на которых выпали 2. ### Возможны 6, 8 или 10 очков.',
  'combination.3': 'Тройки',
  'combination.3.title': 'Сумма всех костей, на которых выпали 3. ### Возможны 9, 12 или 15 очков.',
  'combination.4': 'Четверки',
  'combination.4.title': 'Сумма всех костей, на которых выпали 4. ### Возможны 12, 16 или 20 очков.',
  'combination.5': 'Пятерки',
  'combination.5.title': 'Сумма всех костей, на которых выпали 5. ### Возможны 15, 20 или 25 очков.',
  'combination.6': 'Шестёрки',
  'combination.6.title': 'Сумма всех костей, на которых выпали 6. ### Возможны 18, 24 или 30 очков.',
