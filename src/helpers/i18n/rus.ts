...
export const rus: LanguageMap = {
  ...
  'combination.1.title': 'Сумма всех костей (минимум три кости), на которых выпали единицы. ### Возможны 3, 4 или 5 очков.',
  'combination.2': 'Двойки',
  'combination.2.title': 'Сумма всех костей (минимум три кости), на которых выпали двойки. ### Возможны 6, 8 или 10 очков.',
  'combination.3': 'Тройки',
  'combination.3.title': 'Сумма всех костей (минимум три кости), на которых выпали тройки. ### Возможны 9, 12 или 15 очков.',
  'combination.4': 'Четверки',
  'combination.4.title': 'Сумма всех костей (минимум три кости), на которых выпали четверки. ### Возможны 12, 16 или 20 очков.',
  'combination.5': 'Пятерки',
  'combination.5.title': 'Сумма всех костей (минимум три кости), на которых выпали пятерки. ### Возможны 15, 20 или 25 очков.',
  'combination.6': 'Шестёрки',
  'combination.6.title': 'Сумма всех костей (минимум три кости), на которых выпали шестерки. ### Возможны 18, 24 или 30 очков.',
  ...
  'combination.threeOfAKind.title': 'Три кости, на которых выпали одинаковые значения. В очки записывается сумма этих трёх костей. ### Максимально возможно 18 очков.',
  'combination.equal_4': 'Карэ',
  'combination.equal_4.title': 'Четыре кости, на которых выпали одинаковые значения. В очки записывается сумма этих четырёх костей. ### Максимально возможно 24 очков.',
  ...
  'combination.chance.title': 'Записывается сумма всех выпавших костей. ### Максимально возможно 30 очков.',

  'help.intro': 'Народная игра в кости, напоминающая Покер на костях, предшественник игры Yahtzee.',
